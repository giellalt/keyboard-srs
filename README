.. -*- mode: rst -*-
==========================================
 Keyboards for the Tsuutʼina language
==========================================

This directory contains source files and build instructions for developing
keyboards for the Tsuutʼina language. The data and implementations
...
* http://giellatekno.uit.no/srsdoc/index.html
* http://divvun.no/doc/tools/docu-srs-manual.html
...
The Tsuutʼina keyboard sources can be acquired using the `Giella SVN
